// DOMContentLoaded wrapper removed for stability
        ...
        if (visitedProfile && visitedProfile.username) {
            ...
            if (profileAvatarEl) {
                ...
                profileAvatarEl.onerror = () => {
                    profileAvatarEl.src = "https://media.giphy.com/media/l2YWs1NexTst9YmFG/giphy.gif"; // Try Elf Buddy again or fallback
                    // If even fallback fails, we could use ui-avatars, but let's try a different GIF or keep retry minimal
